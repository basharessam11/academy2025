...
if ($request->filled('search')) {
    ...
    $query->where(function ($q) use ($search) {
        ...
        if ($request->filled('installment') && $request->installment != 0) {
         ...
         return view('employee.booking.index', compact('total', 'month', 'today', 'yesterday', 'bookings'));
     }
 ...
 ->get( );
    ...
    public function create()
    {
        ...
        return view('employee.booking.create',get_defined_vars());
...
if ($request->type ==1) {
    ...
    session()->flash('error', __('employee.amount_exceeds_course_price'));
...
session()->flash('error', __('employee.amount_exceeds_course_price'));
    ...
    public function edit( $id)
    {
        ...
        return view('employee.booking.edit',get_defined_vars());
    ...
    public function success(Request $request)
    {
        ...
        if (isset($response['status']) && $response['status'] == 'COMPLETED') {
            ...
            session()->flash('error', __('employee.Sorry, we were unable to complete your payment. There may be an issue with your payment details or the payment method selected. Please check your details and try again.'));
            return redirect()->route('index');
