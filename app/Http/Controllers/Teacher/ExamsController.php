...
class ExamsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $exams = $query->orderBy('created_at', 'desc')->paginate(10); // هنا يتم تفعيل التصفح



        return view('teacher.exam.index', get_defined_vars());
    }
...
#############################End Product########################################
        ...
        return redirect()->route('exam2.index', $request->exam_id);
    ...
    public function edit($id)
    {
        ...
        $exam = Exams::find($id);
        return view('teacher.exam.edit',get_defined_vars());
...
//   return $exam->type .'<br>'. $request->type ;
        ...
        return redirect()->route('exam2.index');
    }
