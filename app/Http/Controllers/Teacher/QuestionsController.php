...
$exam_id=$request->exam_id;
        ...
        return view('teacher.questions.index', get_defined_vars());
    }
    ...
    public function create($exam_id)
    {
        ...
        return view('teacher.questions.create', get_defined_vars());
    }
...
#############################End questions_select#########################################
        ...
        return redirect()->route('questions2.index1', $request->exam_id);
    ...
    public function edit($id)
    {
        ...
        return view('teacher.questions.edit',get_defined_vars());
