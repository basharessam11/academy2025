                ...
                <div class="card-datatable table-responsive">
                    ...
                    <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                            ...
                            <form method="GET" action="{{ route('exam1.index') }}">
                            ...
                            @foreach ($exams as $key => $exam)
                                <tr class="odd">
                                    ...
                                    <td class="  dt-checkboxes-cell">
                                        <input type="checkbox" value="{{ $exam->exam->id }}" onclick="data('dt-checkboxes')"
                                    ...
                                    <td><span>{{ $exam->exam->title }}</span></td>

                                    <td>
                                        @if ($exam->rate >= 50)
                                            <span class="text-success">%{{ number_format($exam->rate, 1) }}</span>
                                        @elseif ($exam->rate > 0)
                                            <span class="text-danger">%{{ number_format($exam->rate, 1) }}</span>
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            @if ($exam->status == 0)
                                                <a
                                                    href="{{ route('exam1.show', [$exam->exam->id, 'customer_exams_id' => $exam->id]) }}">
                                                    <i class='bx bxs-caret-right-circle fs-4 ms-2'></i>
                                                </a>
                                            @else
                                                تم الامتحان
                                            @endif
