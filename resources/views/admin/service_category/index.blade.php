        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.Languages') !!}</h5>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#products-table').DataTable({
                    ...
                    ajax: '{{ route('service_category.data') }}',
                    columns: [{
                                data: "id"
                            },
                                ...
                                @can('edit service category')
                                    return `
                                        <div class="d-flex align-items-sm-center justify-content-sm-center">
                                            <a href="service_category/${s.id}/edit">
                    ...
                    buttons: [
                        ...
                        @can('create service category')
                            {
                                text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Languages') !!}',
                                ...
                                action: function() {
                                    window.location.href = "{{ route('service_category.create') }}"
                                }
                            }
                        @endcan
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('service_category.destroy', 0) }}">
                                @method('delete')
                                @csrf
