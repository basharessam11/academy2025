        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.Questions') !!}</h5>
                ...
                <div class="card-datatable table-responsive">
                    ...
                    <div id="products-table_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                            ...
                            <form method="GET" action="{{ route('questions.index1', $exam_id) }}">
                            ...
                            <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                                <div
                                    ...
                                    <div class="dt-buttons btn-group flex-wrap">
                                        ...
                                        @canany(['create questions'])
                                            <a href="{{ route('questions.create1', $exam_id) }}">
                                                <button class="btn btn-secondary add-new btn-primary ms-2" tabindex="0"
                                                    ...
                                                    data-bs-target="#offcanvasEcommerceCategoryList"><span><i
                                                            class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Questions') !!}</span></button>
                            ...
                            @foreach ($questions as $question)
                                <tr class="odd">
                                    ...
                                    <td class="  dt-checkboxes-cell">
                                        <input type="checkbox" value="{{ $question->id }}" onclick="data('dt-checkboxes')"
                                    ...
                                    <td><span>{{ $question->exam->title }}</span></td>

                                    <td>
                                        <div class="d-flex align-items-center  ">
                                            @canany(['edit questions'])
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('questions.destroy', 0) }}">
                                @method('delete')
                                @csrf
