        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.Blog Categores') !!}</h5>
                ...
                $('#products-table').DataTable({
                    ...
                    columnDefs: [{
                        ...
                        , {
                            ...
                            render: function(t, e, s, a) {
                                ...
                                @canany(['edit blog category'])
                                    return `
                                        <div class="d-flex align-items-sm-center justify-content-sm-center">
                                            <a href="blog_category/${s.id}/edit">
                    ...
                    buttons: [
                        ...
                        @canany(['create blog category'])
                            {
                                text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Blog Categore') !!}',
                                ...
                                action: function() {
                                    window.location.href = "{{ route('blog_category.create') }}"
                                }
                            }
                        @endcanany
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('blog_category.destroy', 0) }}">
                                @method('delete')
                                @csrf
