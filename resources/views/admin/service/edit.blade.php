                         ...
                         <div class="col-12 col-lg-12">
                             ...
                             <div class="card mb-12">
                                 <div class="card-header">
                                     <h5 class="card-tile mb-0">{!! __('admin.Edit Services Categore') !!}</h5>
                                 </div>
                                 <div class="card-body">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $Services Categore->title_ar }}" placeholder="{!! __('admin.Title_ar1') !!}<"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $Services Categore->title_en }}" placeholder="{!! __('admin.Title_en1') !!}"
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="overview_ar" placeholder="اكتب هنا ">{{ $Services Categore->overview_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="overview_en" placeholder="اكتب هنا ">{{ $Services Categore->overview_en }}</textarea>
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $Services Categore->quote_ar }}" placeholder="quote (arabic)" name="quote_ar"
                                             aria-label="quote">
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text" class="form-control" required id="ecommerce-product-name"
                                             value="{{ $Services Categore->quote_en }}" placeholder="quote (English)" name="quote_en"
                                             aria-label="quote ">
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_ar" placeholder="اكتب هنا ">{{ $Services Categore->description_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_en" placeholder="اكتب هنا ">{{ $Services Categore->description_en }}</textarea>
