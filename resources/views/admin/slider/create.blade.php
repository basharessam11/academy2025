                            ...
                            <div class="card mb-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" required id="ecommerce-product-name"
                                            value="{{ old('description_ar1') }}" placeholder="{!! __('admin.Description_ar1') !!}"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{!! __('admin.Description_en') !!}</label>
                                        <input type="text" class="form-control" required id="ecommerce-product-name"
                                            value="{{ old('description_en1') }}" placeholder="{!! __('admin.Description_en1') !!}"
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <input type="number" class="form-control" id="counter"
                                            value="{{ old('counter') ?? 0 }}" name="counter" aria-label="Counter 4">
                                    </div>
                                    <br>
                                    <div class="col-12 col-md-12">
                                        <label class="form-label mb-0" for="rate">{!! __('admin.Rateing') !!}</label>
                                        <input type="number" class="form-control" id="rate"
                                            value="{{ old('rate') ?? 0 }}" name="rate" aria-label="rate 4">
                                    </div>
