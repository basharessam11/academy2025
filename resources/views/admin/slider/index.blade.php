        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> {!! __('admin.Sliders') !!}</h5>
        ...
        `;
                    ...
                    buttons: [
                        ...
                        @canany(['create slider'])
                            {
                                text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Slider') !!}',
                                ...
                                action: function() {
                                    window.location.href = "{{ route('slider.create') }}"
                                }
                            }
                        @endcanany
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('slider.destroy', 0) }}">
                                @method('delete')
                                @csrf
