                         ...
                         <div class="col-12 col-lg-12">
                             ...
                             <div class="card mb-12">
                                 <div class="card-header">
                                     <h5 class="card-tile mb-0">{!! __('admin.Edit Privacy terms') !!} </h5>
                                 </div>
                                 <div class="card-body">
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_ar" placeholder="اكتب هنا ">{{ $terms->description_ar }}</textarea>
                                     ...
                                     <div>
                                         ...
                                         <textarea id="textarea" class=" form-control" name="description_en" placeholder="اكتب هنا ">{{ $terms->description_en }}</textarea>
