                                        ...
                                        <div class="row mb-3 g-3">
                                            ...
                                            <div class="mb-3 col-12 col-sm-6 form-password-toggle">
                                                <label class="form-label"
                                                    for="confirmPassword">{!! __('admin.Confirm New Password') !!}</label>
                                                <div class="input-group input-group-merge">
                                                    <input class="form-control" type="text" name="password_confirmation"
                                                        value="12345678" id="confirmPassword"
                                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                                                    <span class="input-group-text cursor-pointer"><i
                                                            class="bx bx-hide"></i></span>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="country_id" class="form-select select2" required>
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option @if (old('country_id') == $country->id || $country->id == 66) selected @endif
