        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.Online Sessions') !!}</h5>
                ...
                <div class="card-datatable table-responsive">
                    ...
                    <table id="coursess-table" class="datatables-coursess table border-top dataTable no-footer dtr-column"
                        style="width: 1211px;">
                        <thead>
...
<small class="text-muted text-nowrap">${s.user.email}</small>
                    ...
                    buttons: [
                        ...
                        @canany(['create course'])
                            {
                                text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add Online Sessions') !!} ',
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('courses.destroy', 0) }}">
                                @method('delete')
                                @csrf
