        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{!! __('admin.FAQ') !!}</h5>
            ...
            $(document).ready(function() {
                ...
                $('#products-table').DataTable({
                    ...
                    buttons: [
                        ...
                        @can('create faq')
                            {
                                text: '<i class="bx bx-plus me-0 me-sm-1"></i>{!! __('admin.Add FAQ') !!}',
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" action="{{ route('faq.destroy', 0) }}">
                                @method('delete')
                                @csrf
